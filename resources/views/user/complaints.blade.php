...
<div class="container mx-auto py-8">
    <div class="w-full max-w-lg mx-auto bg-white p-8 shadow-md rounded-lg">
        ...
        <form action="{{ route('complaints.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!-- Nama (Readonly, diambil dari Auth user) -->
            <div class="mb-4">
            ...
            <!-- Dokumentasi (Hanya gambar, ekstensi png, jpg, jpeg) -->
            <div class="mb-4">
            ...
            <div class="mt-6">
                <button type="submit"
                    class="w-full bg-blue-500 text-white p-3 rounded-lg font-bold hover:bg-blue-700">
                    Kirim Pengaduan
                </button>
            </div>
        </form>
