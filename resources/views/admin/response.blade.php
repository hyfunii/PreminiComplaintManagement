...
<div class="container mx-auto py-8">
    ...
    <form action="{{ route('response.search') }}" method="GET" class="max-w-md mx-auto mb-4">
        ...
        <div class="relative">
            ...
            <input type="search" name="query" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search responses..." required />
